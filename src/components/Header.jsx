  ...
  return (
    <nav className="overflow-x-clip bg-white shadow-md">
      {user && user?.displayName && (
        <p className="text-center text-white bg-red-600 py-2 bg-opacity-90 font-semibold">
          ...
          {menu.map((item) => (
            <motion.li key={item.path} variants={menuItemVariants} whileHover="hover">
              <NavLink
                to={item.path}
                className={({ isActive }) =>
                  `font-medium text-lg px-3 py-2 rounded-md transition-colors duration-200 ${isActive ? "bg-blue-600 text-white shadow-lg" : "text-gray-700 hover:bg-gray-100"}`
                }
              >
                {item.name}
              </NavLink>
          ...
          {user && user?.email ? (
            <>
              ...
              <motion.li variants={menuItemVariants} whileHover="hover">
                <button
                  onClick={logOut}
                  className="font-medium text-lg text-red-600 hover:text-red-800 py-2 px-3 rounded-md transition-colors duration-200 bg-red-100 hover:bg-red-200 shadow-sm"
                >
                  Logout
                </button>
              </motion.li>
