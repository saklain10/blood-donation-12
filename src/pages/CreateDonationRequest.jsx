...
// //         <button
// //           type="submit"
// //           className="btn bg-red-500 hover:bg-red-700 text-white font-bold py-3 px-6 rounded-lg text-lg transition duration-200 shadow-lg flex items-center justify-center"
...
//   }, [currentDistrict, setValue, mutableDistrictsData, mutableUpazilasData]);
